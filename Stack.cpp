...
void stackArr::pop(int&val)                         //to return the value of the deleted element by reference
{
    if (isempty()){
    cout<<"stack is empty";
}    
...
void stackArr::peek(int&val){                      //to return the value of the top element by reference
    if (isempty()){
        cout<<"stack is empty";
    }
    else {
